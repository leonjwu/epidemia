...
#' normal, in which case this represents the prior on the reciprocal of the 
#' dispersion parameter for negative binomial and quasi poisson, or the prior 
#' on the standard devation for normal. See \code{\link[rstanarm]{stan_glm}} 
#' for more details.
